...
export default class {
  ...
  handleClickIconEye = () => {
    ...
    const imgWidth = Math.floor($("#modaleFileAdmin1").width() * 0.6);
    $("#modaleFileAdmin1")
      .find(".modal-body")
      .html(
  ...
  handleShowTickets(e, bills, index) {
    ...
    if (this.counter % 2 === 0) {
      ...
      $(`#arrow-icon${this.index}`).css({ transform: "rotate(180deg)" });
    ...
    // insert #status-bills-container${this.index} for validate issue 4
    // console.log(`#status-bills-container${this.index}`, this.counter);
    bills.forEach((bill) => {
